      ...
      <Container className="createContainer">
        <Card className="createCard">
          <Form className="createForm" onSubmit={(e) => this.props.addWorkout(e, this.state)}>
            <Form.Group>
              <Form.Label className="createLabel">Log New Workout</Form.Label>

            </Form.Group>

            <Form.Group>
              <Form.Label className="createFormTitle">Date:</Form.Label>
            ...
            <Form.Group>
              ...
              <Form.Control as='select' name='intensity' onChange={this.handleChange}>
                <option></option>
